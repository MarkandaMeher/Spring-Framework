...
<html lang="en">
  ...
  <body>
    <form class="container mt-5 text-center" action="processForm" method="post">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="userPassword" aria-describedby="emailHelp" placeholder="Enter passWord" name="password">
  </div>
